...
import { zipSync, strToU8 } from '../../player/jsm/libs/fflate.module.js';
...
function MenubarFile( editor ) {
	...
	option.onClick( async function () {
		...
		const { ColladaExporter } = await import( '../../player/jsm/exporters/ColladaExporter.js' );
	...
	option.onClick( async function () {
		...
		const { DRACOExporter } = await import( '../../player/jsm/exporters/DRACOExporter.js' );
	...
	option.onClick( async function () {
		...
		const { GLTFExporter } = await import( '../../player/jsm/exporters/GLTFExporter.js' );
	...
	option.onClick( async function () {
		...
		const { OBJExporter } = await import( '../../player/jsm/exporters/OBJExporter.js' );
	...
	option.onClick( async function () {
		...
		const { PLYExporter } = await import( '../../player/jsm/exporters/PLYExporter.js' );
	...
	option.onClick( async function () {
		...
		const { STLExporter } = await import( '../../player/jsm/exporters/STLExporter.js' );
	...
	option.onClick( async function () {
		...
		const { USDZExporter } = await import( '../../player/jsm/exporters/USDZExporter.js' );
	...
	option.onClick( function () {
		...
		loader.load( '../player/jsm/webxr/VRButton.js', function ( content ) {
