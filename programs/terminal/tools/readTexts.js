...
let textFiles = ["hackEmbeddedSystem", "10", "add-emails", "add-emails-start", "apt-get", "hexdump", "log", "log-1", "sqlHack#sql", "sql#sql", "lorem_ipsum_binary", "apollo_guidance_computer#sql", "randall#python", "shining", "psf#python", "lorem_ipsum", "javascript#javascript", "donut#c", "ascii_schema", "creative-commence-license", "ascii_highvoltage", "test"];
let texts = new Array();
